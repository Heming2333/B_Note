...
var __parent0=require('$model/UI2/B_Note/my'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cv2auqe';
	this._flag_='647feef243a5814db4f636e59faf4a8c';
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":false,"autoNew":false,"confirmDelete":true,"confirmRefresh":true,"defCols":{"EmailAddress":{"define":"EmailAddress","name":"EmailAddress","relation":"EmailAddress","type":"String"},"account":{"define":"account","name":"account","relation":"account","type":"String"},"headimgURL":{"define":"headimgURL","name":"headimgURL","relation":"headimgURL","type":"String"},"nickName":{"define":"nickName","name":"nickName","relation":"nickName","type":"String"},"openId":{"define":"openId","name":"openId","relation":"openId","type":"String"},"password":{"define":"password","name":"password","relation":"password","type":"String"},"userId":{"define":"userId","name":"userId","relation":"userId","type":"String"},"userIntro":{"define":"userIntro","name":"userIntro","relation":"userIntro","type":"String"}},"directDelete":false,"events":{"onCustomRefresh":"userCustomRefresh"},"idColumn":"userId","limit":20,"xid":"user"});
}}); 
return __result;});
